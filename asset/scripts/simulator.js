$(document).ready(function() {
    ...
    const defaultMaterials = [
        ...
        { id: 4, name: "Humus Daun Bambu (Fermentasi)", percentage: 0, retention: 45, drainage: 30, porosity: 55, ph: 5.8 },
        ...
        { id: 15, name: "Top Soil", percentage: 0, retention: 25, drainage: 40, porosity: 50, ph: 5.5 },
