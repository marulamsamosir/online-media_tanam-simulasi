$(document).ready(function() {
    ...
    const defaultMaterials = [
        { id : 1, name : "Sekam Padi Mentah", portion : 0, retention : 35, drainage : 60, porosity : 45, ph : 6.8, cec : 10 },
        { id : 2, name : "Sekam Padi Mentah (Fermentasi)", portion : 0, retention : 45, drainage : 50, porosity : 55, ph : 6.5, cec : 15 },
        { id : 3, name : "Arang Sekam Padi", portion : 0, retention : 65, drainage : 30, porosity : 80, ph : 7.5, cec : 20 },
        { id : 4, name : "Humus Daun Bambu (Fermentasi)", portion : 0, retention : 55, drainage : 40, porosity : 60, ph : 6.2, cec : 25 },
        { id : 5, name : "Humus Daun Kaliandra (Fermentasi)", portion : 0, retention : 60, drainage : 35, porosity : 65, ph : 5.8, cec : 28 },
        { id : 6, name : "Humus Andam (Fermentasi)", portion : 0, retention : 60, drainage : 35, porosity : 65, ph : 5.7, cec : 30 },
        { id : 7, name : "Akar Pakis Cacah (Oven)", portion : 0, retention : 50, drainage : 45, porosity : 70, ph : 5.5, cec : 20 },
        { id : 8, name : "Biji Kapuk / Klenteng (Oven)", portion : 0, retention : 30, drainage : 65, porosity : 50, ph : 6.1, cec : 15 },
        { id : 9, name : "Cocopeat (Fermentasi)", portion : 0, retention : 75, drainage : 20, porosity : 85, ph : 6.0, cec : 30 },
        { id : 10, name : "Cocofiber", portion : 0, retention : 40, drainage : 55, porosity : 75, ph : 5.8, cec : 25 },
        { id : 11, name : "Perlite", portion : 0, retention : 30, drainage : 70, porosity : 90, ph : 7.2, cec : 1 },
        { id : 12, name : "Pasir Malang", portion : 0, retention : 15, drainage : 80, porosity : 50, ph : 6.9, cec : 2 },
        { id : 13, name : "Vermiculite", portion : 0, retention : 60, drainage : 30, porosity : 80, ph : 7.0, cec : 100 },
        { id : 14, name : "Zeolit", portion : 0, retention : 35, drainage : 40, porosity : 60, ph : 7.5, cec : 150 },
        { id : 15, name : "Top Soil", portion : 0, retention : 40, drainage : 30, porosity : 50, ph : 6.5, cec : 15 },
        { id : 16, name : "Pupuk Kandang Kambing (Fermentasi)", portion : 0, retention : 55, drainage : 35, porosity : 65, ph : 7.0, cec : 50 },
        { id : 17, name : "Vermicompost (Kascing)", portion : 0, retention : 65, drainage : 25, porosity : 70, ph : 6.8, cec : 60 },
        { id : 18, name : "Arang Kayu", portion : 0, retention : 20, drainage : 75, porosity : 80, ph : 8.0, cec : 20 },
        { id : 19, name : "Rockwool", portion : 0, retention : 80, drainage : 15, porosity : 95, ph : 7.0, cec : 5 },
        { id : 20, name : "Kerikil", portion : 0, retention : 5, drainage : 95, porosity : 40, ph : 7.0, cec : 1 },
        { id : 21, name : "Pasir Sungai", portion : 0, retention : 10, drainage : 85, porosity : 45, ph : 7.0, cec : 2 },
        { id : 22, name : "Hydroton", portion : 0, retention : 40, drainage : 55, porosity : 80, ph : 7.0, cec : 5 },
        { id : 23, name : "Spagnum Peat Moss", portion : 0, retention : 85, drainage : 10, porosity : 90, ph : 4.0, cec : 100 },
        { id : 24, name : "Biochar", portion : 0, retention : 70, drainage : 25, porosity : 85, ph : 7.8, cec : 40 },
        { id : 25, name : "Pumice", portion : 0, retention : 35, drainage : 60, porosity : 80, ph : 7.2, cec : 10 }
    ];
